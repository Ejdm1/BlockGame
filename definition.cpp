...
{
    CGRect frame = (CGRect){ {100.0, 100.0}, {980,980} };
...
void Renderer::buildBuffers()
{
    ...
    simd::float3 colors2[NumVertices] =
    {
        {  0.8f, 0.0f, 1.0f },
        {  0.8f, 1.0f, 0.0f },
        {  1.0f, 0.3f, 0.2f }
    ...
    memcpy( _pVertexPositionsBuffer->contents(), positions2, positionsDataSize );
    memcpy( _pVertexColorsBuffer->contents(), colors2, colorDataSize );
